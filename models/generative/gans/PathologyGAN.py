...
class PathologyGAN(GAN):
	...
	def generator(self, w_latent, reuse, is_train, init):
		output = generator_resnet_style(z_input=w_latent, image_channels=self.image_channels, layers=self.layers, spectral=self.spectral, activation=leakyReLU, reuse=reuse, is_train=is_train,
